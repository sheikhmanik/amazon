...
export default function CategoryProducts() {
    ...
    useEffect(() => {
        ...
        fetch('https://dummyjson.com/products')
            .then(res => res.json())
            .then(data => {
                setProducts(data.products.filter(product => product.category.toLowerCase() === 'beauty'));
                setIsLoading(false);
            })
    }, []);
        ...
        <div className="sm:mx-5">
            ...
            {!isLoading && (
                <div className="flex flex-col gap-5">
                    <h3 className="font-Montserrat uppercase font-bold text-xl md:text-2xl ml-5">All Category</h3>
